...
## Corpus Check
- 120 files · ~61,071 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 627 nodes · 1209 edges · 53 communities (44 shown, 4 thin omitted)
...
- `AuditClientView()` --calls--> `formatTanggal()`  [EXTRACTED]
  src/app/dashboard/audit/audit-client-view.tsx → src/lib/utils.ts
- `AuditPage()` --calls--> `getSessionUser()`  [EXTRACTED]
  src/app/dashboard/audit/page.tsx → src/lib/auth/session.ts
- `DebtClientView()` --calls--> `formatRupiah()`  [EXTRACTED]
  src/app/dashboard/debts/debt-client-view.tsx → src/lib/utils.ts
...
Cohesion: 0.06
Nodes (56): RestockClientView(), RestockClientViewProps, RestockModal(), RestockModalProps, InvoicePrintPage(), PosClient(), PosClientProps, PosPaymentModal() (+48 more)

### Community 1 - "superadmin.ts"
Cohesion: 0.09
Nodes (51): LoginPage(), DashboardLayout(), DashboardHomePage(), LogAuditInput, ActionResult, loginAction(), logoutAction(), registerTenantAction() (+43 more)

### Community 2 - "debts/page.tsx"
Cohesion: 0.20
Nodes (11): CustomerModal(), CustomerModalProps, DebtClientView(), DebtClientViewProps, DebtPaymentModal(), DebtPaymentModalProps, DebtsPage(), createCustomerAction() (+3 more)

### Community 3 - "getSessionUser"
Cohesion: 0.08
Nodes (43): OpnameClientView(), OpnameClientViewProps, OpnameModal(), OpnameModalProps, OpnamePage(), InventoryPage(), RestockPage(), PosPage() (+35 more)
...
Cohesion: 0.13
Nodes (15): jetbrainsMono, metadata, plusJakartaSans, viewport, SuperadminSettingsPage(), SettingsClientView(), SettingsClientViewProps, ensurePunctuation() (+7 more)
...
Cohesion: 0.15
Nodes (14): BarcodeModal(), BarcodeModalProps, ImportModal(), ImportModalProps, Category, ProductModal(), ProductModalProps, ProductTable() (+6 more)
...
### Community 51 - "dashboard/audit/page.tsx"
Cohesion: 0.47
Nodes (4): AuditClientView(), AuditClientViewProps, AuditPage(), getAuditLogsAction()
...
- **Why does `getSessionUser()` connect `getSessionUser` to `formatRupiah`, `superadmin.ts`, `debts/page.tsx`, `superadmin/layout.tsx`, `toast.tsx`, `dashboard/audit/page.tsx`, `middleware.ts`, `product-table.tsx`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `formatRupiah()` connect `formatRupiah` to `superadmin.ts`, `debts/page.tsx`, `getSessionUser`, `product-table.tsx`?**
